package com.bside.BSIDE.security.filter;
...
import com.bside.BSIDE.jwt.exception.JwtExceptionCode;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void getAuthentication(String token) {
        JwtAuthentication authenticationToken = new JwtAuthentication(token);
